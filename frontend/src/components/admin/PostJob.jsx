    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-center w-full px-4 sm:px-6 lg:px-8 my-5'>
                <form onSubmit={submitHandler} className='p-4 sm:p-6 md:p-8 max-w-4xl w-full border border-gray-200 shadow-lg rounded-md'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4'>
                        ...
                        <div>
                            <Label className="text-sm sm:text-base">Salary (LPA)</Label>
                            <Input
                                type="text"
                                name="salary"
                                value={input.salary}
                        ...
                        <div>
                            <Label className="text-sm sm:text-base">Experience Level</Label>
                            <Input
                                type="text"
                                name="experience"
                        ...
                        <div>
                            <Label className="text-sm sm:text-base">No of Positions</Label>
                            <Input
                                type="number"
                                name="position"
                    ...
                    {loading ? (
                        <Button className="w-full my-4 sm:my-6 bg-[#0000ff] hover:bg-[#1134a6]" disabled>
                            <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Please wait
                        </Button>
                    ) : (
                        <Button type="submit" className="w-full my-4 sm:my-6 bg-[#0000ff] hover:bg-[#1134a6]">
                            Post New Job
                        </Button>
                    )}
                    {companies.length === 0 && (
