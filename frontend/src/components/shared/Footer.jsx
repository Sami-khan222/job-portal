...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-6 sm:py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          <div className="text-center md:text-left">
            <h2 className="text-xl font-bold">Next Hire</h2>
            <p className="text-xs sm:text-sm text-gray-600 mt-1">© 2026 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-gray-600 transition-colors duration-200" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-gray-600 transition-colors duration-200" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-600 transition-colors duration-200" aria-label="LinkedIn">
